...
| PotW 2 (18&19&20)     | Deck of Cards                   | 100    | sliding window                                                                                                    |
...
| PotW 5 (19&20)        | Motorcycles                     | 100    | sorting by increasing slope and then linear pass to test for intersections                                        |
...
| 5                     | Asterix and the tour of Gaul    | 100    | min cost max flow                                                                                                 |
| old 5                     | Ligth at the Museum             | 100    | split & list, brute force all switch configurations                                                               |
| old 5                     | Punch                           | 100    | dynamic programming, 2D table for beverages x liters                                                              |
...
| PotW 7 (18&20)        | Octopussy                       | 100    | greedy with recursive dependency resolution                                                                       |
...
| PotW 8                | Surveillance Photographs        | 100    | max flow on graph with two layers                                                                                 |
...
| 8 | Clues | 100 | Delaunay triangulation with disks |
...
| 9 | Placing Knigths| 100 | - |
| old 9                 | Canteen                         | 100    | min cost max flow, days as nodes and edges between days as fridge                                                 |
| old 9                 | Marathon                        | 100    | multiple max flow min cost & binary search to find the optimal flow                                               |
| 9                     | Casino Royale                   | 100    | min cost max flow, space-time graph (see Carsharing)                                                              |
| PotW 10               | Idefix                          | 100    |                                                                                                                   |
