...
# revised by Fabian Ulbricht, HS 2019
VERSION="0.2"
...
case "$1" in
    ...
    init)
    	...
    	echo ""
        cd ../release
        cmake cmake -DCMAKE_BUILD_TYPE=Release -DCGAL_DONT_OVERRIDE_CMAKE_FLAGS=True ../..
        echo ""
